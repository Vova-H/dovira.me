...
const Banner = ({scrollTo, refs}) => {
    ...
    return (
        <div className={classes.bannerWrapper}>
                <h1 className={classes.title} data-aos="fade-left" data-aos-delay="200">Are you tired of queues in hospitals?</h1>
                <p className={classes.subtitle} data-aos="fade-left" data-aos-delay="200">Get quality doctor visits from home with Medivisit.</p>
